...
namespace NetIOCP.AsyncSocketCore
{
    ...
    public class AsyncSocketUserToken
    {
        ...
        /// 发送端口占用
        /// </summary>
        protected bool m_sendAsyncState;

        public bool SendAsyncState { get { return m_sendAsyncState; } set { m_sendAsyncState = value; } }

        //根据收到的心跳协议，定制查询指令
        protected string strQueryCommand = "";
        public string StrQueryCommand {
            get { return strQueryCommand; }
            set { strQueryCommand = value; }
        }
